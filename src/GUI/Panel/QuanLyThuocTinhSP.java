...
public class QuanLyThuocTinhSP extends JPanel {
    ...
    String iconst[] = {"brand_100px.svg", "factory_100px.svg", "brand_100px.svg", "factory_100px.svg"};

    String header[] = {"Thương hiệu", "Xuất xứ", "Loại món ăn", "Size sản phẩm",};
    ...
    private void initComponent() {
        ...
        listitem[2].addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
                hdh = new SizeMatHangDialog(owner, QuanLyThuocTinhSP.this, "Quản lý loại món ăn", true,m.user.getManhomquyen());
                hdh.setVisible(true);
            }
        });
