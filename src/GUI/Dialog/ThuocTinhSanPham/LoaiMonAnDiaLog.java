...
public final class LoaiMonAnDiaLog extends JDialog implements MouseListener {
    ...
    public LoaiMonAnDiaLog(JFrame owner, QuanLyThuocTinhSP qltt, String title, boolean modal, int nhomquyen) {
